...
| `zig-vst3-plugin/src/dsp/adm_render/core.zig` | 3,123 / 3,982 | Implements object rendering and direct-speaker routing behind the exact public aliases in `dsp/adm_render.zig`. Shared geometry lives in `adm_render/common.zig`; point and extent panning live in `adm_render/panner.zig`; matrix rendering lives in `adm_render/matrix.zig`. | SPLIT. Extract the two remaining rendering families from this temporary implementation module. |
...
- `zig-vst3-plugin/src/dsp/adm_render/core.zig` | 7105 | 3123 | 3982 | SPLIT
