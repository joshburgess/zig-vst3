...
| `zig-vst3-plugin/src/dsp/adm_render/core.zig` | 3,814 / 3,982 | Implements point and extent panning, object rendering, and direct-speaker routing behind the exact public aliases in `dsp/adm_render.zig`. Shared vocabulary lives in `adm_render/common.zig`, and matrix rendering lives in `adm_render/matrix.zig`. | SPLIT. Continue extracting the three remaining rendering families from this temporary implementation module. |
...
- `zig-vst3-plugin/src/dsp/adm_render/core.zig` | 7796 | 3814 | 3982 | SPLIT
