...
| `zig-vst3-plugin/src/lv2.zig` | 5,861 / 4,455 | Defines the LV2 ABI vocabulary and owns plugin instance, feature negotiation, worker, state, programs, and dynamic-port lifecycles. | SPLIT. Extract raw ABI declarations and URI vocabulary from the stateful plugin adapter, preserving public aliases. |
...
- `zig-vst3-plugin/src/lv2.zig` | 10316 | 5861 | 4455 | SPLIT
