...
The checked inventory contains 823 source files and 470,985 source lines.
...
| --- | --- | ---: | ---: | --- | --- | --- | --- |
| Q00 | Build graph, CI, release and validation scripts | 126 | 17,721 | 4/4/5/4 | Elevated | Release contents, tool execution, cross-target gates | Script fixtures, package smoke, clean-tree release graph |
...
| Q15 | DSP primitives, convolution, filters, effects, resampling, and numerics | 62 | 33,519 | 5/4/5/4 | High | Numerical stability, bounds, realtime execution and publication | Independent vectors, property tests, finite containment, TSan, benchmarks |
...
| Q21 | Test hosts, reference adapters, and downstream fixtures | 101 | 29,751 | 3/3/4/4 | Moderate | Oracle correctness and false confidence | Mutation review, independent provenance, fixture self-tests |
