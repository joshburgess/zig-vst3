...
The checked inventory contains 820 source files and 468,711 source lines.
...
| --- | --- | ---: | ---: | --- | --- | --- | --- |
| Q00 | Build graph, CI, release and validation scripts | 126 | 17,496 | 4/4/5/4 | Elevated | Release contents, tool execution, cross-target gates | Script fixtures, package smoke, clean-tree release graph |
...
| Q16 | Toolkit-neutral GUI state and models | 16 | 9,005 | 4/4/4/4 | Elevated | Callback lifetime, user input, resource transfer | State models, malformed input, lifecycle and concurrency stress |
...
| Q21 | Test hosts, reference adapters, and downstream fixtures | 101 | 29,718 | 3/3/4/4 | Moderate | Oracle correctness and false confidence | Mutation review, independent provenance, fixture self-tests |
