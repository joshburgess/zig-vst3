...
| Q10 | Ogg and Vorbis | 3 | 31,570 | 5/5/5/4 | High | Untrusted packets, checked arithmetic, codec state, seeking | Fuzzing, truncation, sanitizer runs, independent decoders |
| Q11 | MP3 | 9 | 31,416 | 5/5/5/4 | High | Untrusted frames, bit reservoirs, Huffman data, synthesis | Fuzzing, corruption, sanitizer runs, independent decoders |
...
| Q15 | DSP primitives, convolution, filters, effects, resampling, and numerics | 63 | 33,570 | 5/4/5/4 | High | Numerical stability, bounds, realtime execution and publication | Independent vectors, property tests, finite containment, TSan, benchmarks |
