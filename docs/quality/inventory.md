...
| --- | --- | ---: | ---: | --- | --- | --- | --- |
| Q00 | Build graph, CI, release and validation scripts | 126 | 17,811 | 4/4/5/4 | Elevated | Release contents, tool execution, cross-target gates | Script fixtures, package smoke, clean-tree release graph |
