...
| Preset attribute keys, state type keys, musical instrument keys, and musical character keys | Initial string constant translation complete; values checked against the pinned SDK with `zig build preset-keys-abi` |
