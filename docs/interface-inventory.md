...
| `IAudioProcessor`, `IAudioPresentationLatency`, `IProcessContextRequirements`, and core audio processor helpers | Initial vtable, struct, and helper translation complete; layout checked against the pinned SDK with `zig build audio-processor-abi` |
