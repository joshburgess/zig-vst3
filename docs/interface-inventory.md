...
| Preset attribute keys and state type keys | Initial string constant translation complete; values checked against the pinned SDK with `zig build preset-keys-abi` |
