...
| `IPluginFactory`, `IPluginFactory2`, `IPluginFactory3` | Initial vtable and struct translation complete; reusable static factory helper in `factory.zig` covers metadata/class enumeration, fixed string truncation, invalid class clearing, create-instance dispatch, failed create output clearing, and query behavior |
