...
| `IUpdateHandler`, `IDependent`, `IPluginCompatibility` | Initial vtable translation complete; constants and IIDs checked against the pinned SDK with `zig build base-update-compatibility-abi`; reusable compatibility JSON helper includes basic metadata fixture generation and deterministic streaming failures |
