...
| LV2 | `zig-vst3-plugin/src/lv2*`, `zig-vst3/src/vstgui_lv2_backend.zig`, Mono Gain LV2 examples, bundle scripts and host fixtures | `test-lv2`, bundle verification, ABI harness, installed-package tests | Committed in `3dead5d`; clean baseline and final LV2 gates passed. Independent RDF and `lv2lint` validation completed 2026-07-29; external hosts remain separate |
