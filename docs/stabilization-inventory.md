...
| MIDI and MIDI-CI | `zig-vst3-plugin/src/process/midi*`, `mpe*`, `process.zig`, installed-consumer coverage | process module tests, installed-package tests, cross-target compilation | Committed in `e601392`; clean core passed 581/581; public export review remains |
