...
- Unit metadata validation rejects missing or duplicate root units, empty unit or program names, duplicate program-list ids, duplicate program names, duplicate program parameter ids, duplicate program info keys, missing unit parents, and unit links to unknown program lists.
