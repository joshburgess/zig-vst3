...
Checked output-event writer coverage includes direct append planning, append counts, capacity state, query views, block segments, validation failures, and clearing.
