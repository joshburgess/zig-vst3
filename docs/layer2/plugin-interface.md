...
Checked input-event helper coverage includes direct event-view validation, count, emptiness, first/latest, next-offset, iterator, routing, only predicates, and empty input fallbacks.
