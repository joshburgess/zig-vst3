...
- `Event.validate`, `Events.init`, and `EventWriter` reject events outside the current process block and reject non-finite or out-of-range normalized event values.
