...
- `ProcessContext.appendOutputEvent`, `appendOutputEvents`, `writtenOutputEvents`, `outputEventCount`, `outputEventCapacity`, and `outputEventRemainingCapacity` let processors write, inspect, and plan output events without unwrapping the optional writer.
