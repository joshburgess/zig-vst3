...
- `ParameterEditor(Params)`: a descriptor/value pair for typed, normalized, plain-id, and normalized-id stores plus default reset without passing the set into each call.
