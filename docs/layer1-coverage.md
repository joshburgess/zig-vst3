...
| Validator | macOS validator in public CI; Linux validator enabled for native CI runs | Windows validator when runners can build and execute Steinberg validator reliably |
