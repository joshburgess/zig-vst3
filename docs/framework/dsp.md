...
The fixed math types reject non-finite construction and arithmetic results. Their dimensions, fit point counts, degrees, and storage capacities remain compile-time bounds. Dynamic matrices and additional polynomial families such as Hermite, Laguerre, and general Jacobi remain outside this layer.
