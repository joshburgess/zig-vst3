...
Variable Matrix coefficient policy, Matrix phase processing, HOA loudspeaker-matrix generation, timed binaural gain, and HRTF synthesis remain separate layers.
