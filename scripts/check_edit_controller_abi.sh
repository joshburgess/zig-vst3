...
out_dir="${ZIG_LOCAL_CACHE_DIR:-.zig-cache}/edit-controller-abi"
...
"${ZIG:-zig}" run --dep zig-vst3 -Mroot=tools/edit_controller_layout.zig -Mzig-vst3=zig-vst3/src/root.zig > "$out_dir/zig.txt"
