...
out_dir="${ZIG_LOCAL_CACHE_DIR:-.zig-cache}/host-message-abi"
...
"${ZIG:-zig}" run --dep zig-vst3 -Mroot=tools/host_message_layout.zig -Mzig-vst3=zig-vst3/src/root.zig > "$out_dir/zig.txt"
