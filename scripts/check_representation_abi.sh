...
out_dir="${ZIG_LOCAL_CACHE_DIR:-.zig-cache}/representation-abi"
...
"${ZIG:-zig}" run --dep zig-vst3 -Mroot=tools/representation_layout.zig -Mzig-vst3=zig-vst3/src/root.zig > "$out_dir/zig.txt"
