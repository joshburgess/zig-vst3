...
cp tests/installed-consumer/build.zig tests/installed-consumer/build.zig.zon tests/installed-consumer/editors.zig tests/installed-consumer/dsp_fixture.zig tests/installed-consumer/kernel_plugin.zig "$consumer/"
...
printf 'installed-package effect, instrument, DSP fixture, and C kernel consumers passed\n'
