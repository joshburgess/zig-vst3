...
pub const IInterAppAudioHostVTable = extern struct {
    ...
    getScreenSize: *const fn (*anyopaque, [*c]iplugview.ViewRect, [*c]f32) callconv(.c) base_types.tresult,
    ...
    getHostIcon: *const fn (*anyopaque, [*c]?*anyopaque) callconv(.c) base_types.tresult,
    scheduleEventFromUI: *const fn (*anyopaque, [*c]events.Event) callconv(.c) base_types.tresult,
    createPresetManager: *const fn (*anyopaque, [*c]const tuid.TUID) callconv(.c) ?*IInterAppAudioPresetManager,
