...
pub const output_param_id: u32 = 5;
...
const EditorSmokePlugin = struct {
    ...
    pub const Params = struct {
        ...
        output: plug.parameters.FloatParam = .{ .id = output_param_id, .name = "Output", .short_name = "Output", .units = "dB", .min = -24.0, .max = 24.0, .default = 0.0 },
