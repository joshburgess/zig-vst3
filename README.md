...
- Reusable `IMessage`, `IErrorContext`, `IStringResult`, `IString`, `IAttributes`, `IAttributes2`, `IAttributeList`, and `IStreamAttributes` utility objects for host/plugin notifications, error reporting, and state/preset metadata
