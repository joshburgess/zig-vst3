...
- Reusable `IMessage`, `IErrorContext`, `IStringResult`, `IString`, `IAttributes`, `IAttributes2`, `IUpdateHandler`, `IDependent`, `IAttributeList`, and `IStreamAttributes` utility objects for host/plugin notifications, error reporting, dependency updates, and state/preset metadata
