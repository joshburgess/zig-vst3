...
```sh
zig fetch --save=zig_vst3 https://github.com/joshburgess/zig-vst3/archive/refs/tags/zig-vst3-0.3.0.tar.gz
```
...
- [docs/stability.md](docs/stability.md): current compatibility policy.
