...
- Decode complete MPEG Layer III frames through gapless stream ranges. Emit checked constant-bitrate MPEG-1, MPEG-2, and MPEG-2.5 headers, exact padding cadence, optional CRC protection, silent frames, side information, every pair and count1 Huffman codebook, and caller-planned quantized spectral frames transactionally.
