...
- Reusable component and controller shells covering default VST3 connection point, optional plug-view factory hook, reusable parameter-finder object, host application context, host channel-context and automation-state listeners, component-handler automation callbacks, component-handler editor/group/context-menu/bus/system-time callbacks, unit info and unit-handler callbacks, MIDI mapping/learn, note expression, keyswitch, physical UI mapping, parameter helper, unit data, edit-controller extension, process-context requirement, and processor capability interfaces
