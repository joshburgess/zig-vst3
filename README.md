...
- `zig-plug` plugin specs and instances with reflected defaults, plugin/factory/class metadata, lifecycle validation, typed parameter access, bound parameter views, parameter existence and default-reset helpers, parameter state read/write with restore reports and migration validation, and process dispatch for 32-bit and 64-bit audio
