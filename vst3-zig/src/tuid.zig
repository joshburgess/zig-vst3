...
test "INLINE_UID matches SDK layout for P0 interfaces" {
    const cases = [_]struct {
        ...
        .{
            ...
            .com = .{ 0xDB, 0x8D, 0x88, 0x22, 0x45, 0xAE, 0x6E, 0x15, 0x83, 0x58, 0xB3, 0x48, 0x08, 0x19, 0x06, 0x25 },
        },
        .{
            .name = "IComponent",
            ...
            .com = .{ 0x31, 0xFF, 0x31, 0xE8, 0x43, 0x01, 0xD5, 0xF2, 0x92, 0x8E, 0xBB, 0xEE, 0x25, 0x69, 0x78, 0x02 },
        },
        .{
            ...
            .com = .{ 0x99, 0x3F, 0x04, 0x42, 0x45, 0x3C, 0xDA, 0xB7, 0xA5, 0x69, 0xE7, 0x9D, 0x9A, 0xAE, 0xC3, 0x3D },
        },
        .{
            ...
            .com = .{ 0xE3, 0xBB, 0xD7, 0xDC, 0x44, 0x8D, 0x42, 0x77, 0xA8, 0x74, 0xAA, 0xCC, 0x97, 0x9C, 0x75, 0x9E },
        },
    };
