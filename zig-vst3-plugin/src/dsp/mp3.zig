...
pub const XingKind = mp3_decoder.XingKind;
pub const Xing = mp3_decoder.Xing;
pub const Vbri = mp3_decoder.Vbri;
pub const VbriSummary = mp3_decoder.VbriSummary;
pub const Frame = mp3_decoder.Frame;
pub const Summary = mp3_decoder.Summary;
pub const SeekPoint = mp3_decoder.SeekPoint;
pub const FileFrame = mp3_decoder.FileFrame;
pub const FileSummary = mp3_decoder.FileSummary;
pub const Stream = mp3_decoder.Stream;
pub const FileReader = mp3_decoder.FileReader;
pub const requiredSeekPoints = mp3_decoder.requiredSeekPoints;
pub const buildSeekIndex = mp3_decoder.buildSeekIndex;
pub const findSeekPoint = mp3_decoder.findSeekPoint;
pub const requiredFileSeekPoints = mp3_decoder.requiredFileSeekPoints;
pub const buildFileSeekIndex = mp3_decoder.buildFileSeekIndex;
pub const buildFileSeekIndexTransactional =
    mp3_decoder.buildFileSeekIndexTransactional;
...
const minimumFrameBytes = mp3_decoder.minimumFrameBytes;
const crc16 = mp3_decoder.crc16;
...
const leadingTagBytes = mp3_decoder.leadingTagBytes;
const containsNonzero = mp3_decoder.containsNonzero;
const resolvedFrameBytes = mp3_decoder.resolvedFrameBytes;
...
const frameAtKnownLength = mp3_decoder.frameAtKnownLength;
const trailingTagStart = mp3_decoder.trailingTagStart;
