...
const capture_api = @import("standalone/capture.zig");
const standalone_common = @import("standalone/common.zig");
...
pub const ClockDriftConfig = capture_api.ClockDriftConfig;
pub const ClockDriftController = capture_api.ClockDriftController;
pub const CaptureFifoWriteReport = capture_api.CaptureFifoWriteReport;
pub const CaptureFifoReadReport = capture_api.CaptureFifoReadReport;
pub const CaptureFifoStatistics = capture_api.CaptureFifoStatistics;
pub const BoundedCaptureFifo = capture_api.BoundedCaptureFifo;
pub const CaptureRateBridgeConfig = capture_api.CaptureRateBridgeConfig;
pub const CaptureRateUnderflowPolicy = capture_api.CaptureRateUnderflowPolicy;
pub const CaptureRateOverflowPolicy = capture_api.CaptureRateOverflowPolicy;
pub const CaptureRateLifecycleConfig = capture_api.CaptureRateLifecycleConfig;
pub const CaptureRateOperatingState = capture_api.CaptureRateOperatingState;
pub const CaptureRateRenderReport = capture_api.CaptureRateRenderReport;
pub const BoundedCaptureRateBridge = capture_api.BoundedCaptureRateBridge;
...
const nextQueueIndex = standalone_common.nextQueueIndex;
const advanceFifoIndex = standalone_common.advanceFifoIndex;
const sampleSlicesOverlap = standalone_common.sampleSlicesOverlap;
...
const recordSaturating = standalone_common.recordSaturating;
const recordSaturatingAmount = standalone_common.recordSaturatingAmount;

test "standalone capture public names remain exact aliases" {
    comptime {
        if (ClockDriftConfig != capture_api.ClockDriftConfig or
            ClockDriftController != capture_api.ClockDriftController or
            CaptureFifoWriteReport != capture_api.CaptureFifoWriteReport or
            CaptureFifoReadReport != capture_api.CaptureFifoReadReport or
            CaptureFifoStatistics != capture_api.CaptureFifoStatistics or
            BoundedCaptureFifo(f32, 1, 1) != capture_api.BoundedCaptureFifo(f32, 1, 1) or
            CaptureRateBridgeConfig != capture_api.CaptureRateBridgeConfig or
            CaptureRateUnderflowPolicy != capture_api.CaptureRateUnderflowPolicy or
            CaptureRateOverflowPolicy != capture_api.CaptureRateOverflowPolicy or
            CaptureRateLifecycleConfig != capture_api.CaptureRateLifecycleConfig or
            CaptureRateOperatingState != capture_api.CaptureRateOperatingState or
            CaptureRateRenderReport != capture_api.CaptureRateRenderReport or
            BoundedCaptureRateBridge(f32, 1, 4, 2, 2) != capture_api.BoundedCaptureRateBridge(f32, 1, 4, 2, 2))
        {
            @compileError("standalone capture public alias identity changed");
        }
    }
}
