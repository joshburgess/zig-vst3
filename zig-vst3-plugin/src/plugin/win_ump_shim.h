#ifndef ZIG_VST3_WIN_UMP_SHIM_H
#define ZIG_VST3_WIN_UMP_SHIM_H
...
enum {
    ZV3_WIN_UMP_INPUT = 0,
    ZV3_WIN_UMP_OUTPUT = 1
};

typedef void (*zv3_win_ump_receive_fn)(
    void *context,
...
typedef struct zv3_win_ump_input zv3_win_ump_input;
typedef struct zv3_win_ump_output zv3_win_ump_output;

typedef struct {
    uint64_t read_failures;
} zv3_win_ump_input_statistics;
